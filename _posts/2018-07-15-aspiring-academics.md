...
Consider then doing an M.Tech/M.S. at any of (and only) the top universities in India by writing and excelling at [GATE](https://en.wikipedia.org/wiki/Graduate_Aptitude_Test_in_Engineering), or alternatively, work at a cutting edge corporate research lab. Finding such labs are hard, since they generally require advanced degrees to get in in the first place (see the [Resources](#resources) section for a few that I know of). 
